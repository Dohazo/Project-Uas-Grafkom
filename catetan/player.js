...
export class Player{
    ...
    loadModel(){
        ...
        loader.setPath("./Animation/");
        loader.load('Happy idle.fbx', (fbx) => {
            ...
            var loader = new FBXLoader();
            loader.setPath("./Animation/");
            loader.load('Happy idle.fbx', (fbx) => {onLoad('idle', fbx);});
...
export class PlayerController{
    constructor(){
        ...
        this.deltaMousePos = new THREE.Vector3();
    ...
    onKeyDown(event){
        ...
        switch(event.key){
            ...
            case "J":
            case "j": this.keys["up"] = true; break
            case "K":
            case "k": this.keys["down"] = true; break
        }
    }
    ...
    onKeyUp(event){
        switch(event.key){
            ...
            case "J":
            case "j": this.keys["up"] = false; break
            case "K":
            case "k": this.keys["down"] = false; break
        }
    }
}
